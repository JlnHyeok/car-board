    ...
    <div className='register-wrap'>
      <div className='register-input-box'>
        <form className='register-info' onSubmit={handleSignUpSubmit}>
          ...
          <input type="password" placeholder='비밀번호 입력해주세요.' onChange={e=>setRegisterPw(e.target.value)}/><br />
          <input type="password" placeholder='비밀번호 확인.' onChange={e=>setRegisterPwConfirm(e.target.value)}/><br />
